...
function scoreDrink(drink, answer) {
  ...
  if (doListsIntersect(drink.tags, ['amaro', 'amaro-nonino', 'amaro-montenegro'])) {
  ...
  if (doListsIntersect(drink.tags, ['amaretto', 'cointreau', 'grand-marnier'])) {
    score -= unit * 2; // Smooth but can have some complexity
  }
  
  // Bitters and cocktail modifiers (±2-3)
  if (doListsIntersect(drink.tags, ['angostura', 'peychauds', 'orange-bitters'])) {
